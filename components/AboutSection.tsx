  ...
  return (
    ...
    >
      <Reveal>
        ...
        <h2 className="font-display italic text-5xl md:text-7xl mb-12 text-text">Sid Lim</h2>
      </Reveal>
      ...
      <Reveal delay={0.1}>
        <h3 className="font-display italic text-3xl md:text-4xl mb-8 text-text">
      ...
      <div className="grid sm:grid-cols-2 gap-px bg-stroke rounded-2xl overflow-hidden border border-stroke">
        {CAPABILITIES.map((cap, i) => (
          <Reveal key={cap.title} delay={i * 0.1} className="bg-surface p-8">
            <h4 className="font-display italic text-xl text-text mb-3">{cap.title}</h4>
