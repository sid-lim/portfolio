...
export default function ResumePage() {
  return (
    <main className="min-h-screen pt-32 pb-24 px-6 md:px-12 max-w-4xl mx-auto">
      ...
      <h1 className="font-display italic text-5xl md:text-7xl mb-16 text-text">Experience</h1>
      ...
      <section>
        <h2 className="font-display italic text-2xl md:text-3xl text-text mb-6">Full Resume</h2>
